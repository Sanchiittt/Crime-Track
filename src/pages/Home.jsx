...
//         <div className="absolute inset-0 bg-black/10 backdrop-blur-[1.5px] -z-10"></div>
...
const Home = () => {
  ...
  return (
    <div className="relative w-full overflow-x-hidden text-white">
      ...
      {/* Hero Section */}
<section className="relative flex flex-col md:flex-row items-center h-auto md:h-screen px-4 sm:px-6 md:px-20 py-32 md:py-0">
  <div className="absolute inset-0 bg-black/10 backdrop-blur-[1.5px] -z-10"></div>

        {/* Left Text */}
  <div className="md:w-1/2 flex flex-col items-center md:items-start space-y-6 text-center md:text-left order-1 md:order-1">
    <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold drop-shadow-xl">
      Stay Vigilant. Report Crimes.
    </h1>
          <p className="text-md sm:text-lg md:text-xl max-w-md text-gray-200 drop-shadow-md">
            CrimeTrack connects citizens and police to ensure timely action and safer neighborhoods.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <Link
              to="/signup"
              className="px-6 sm:px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 rounded-full shadow-lg transition-all duration-300 text-lg font-semibold"
            >
              Report Crime
            </Link>
            <Link
              to="/login"
              className="px-6 sm:px-8 py-3 bg-gradient-to-r from-purple-600 to-purple-800 hover:from-purple-700 hover:to-purple-900 rounded-full shadow-lg transition-all duration-300 text-lg font-semibold"
            >
              Police Login
            </Link>
          </div>
        ...
        {/* Right Card */}
        <div className="md:w-1/2 mt-8 md:mt-0 flex justify-center items-center order-2 md:order-2">
          <div className="bg-black/70 backdrop-blur-[2px] p-4 sm:p-6 md:p-6 rounded-xl shadow-2xl max-w-sm text-center">
      ...
      {/* How It Works Section */}
      <section className="relative py-16 md:py-32 px-4 sm:px-6 md:px-20">
        <div className="absolute inset-0 bg-black/60 backdrop-blur-[1px] -z-10"></div>
        <h2 className="text-3xl sm:text-4xl font-bold mb-12 text-center drop-shadow-lg">
          How It Works
        </h2>
        <div className="flex flex-col space-y-12">
          {/* Card 1 */}
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="md:w-1/2 bg-black/70 backdrop-blur-[2px] p-6 sm:p-8 rounded-xl shadow-2xl">
              <h3 className="text-2xl font-semibold mb-2">Report a Crime</h3>
              <p className="text-gray-200 text-sm sm:text-base">
                Citizens can submit complaints with details about the incident quickly and securely.
              </p>
      ...
      <section className="relative py-16 md:py-32 px-4 sm:px-6 md:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 text-center md:text-left">
          <div>
            <div className="text-3xl sm:text-4xl md:text-5xl font-bold drop-shadow-lg">{complaints}+</div>
            <p className="text-gray-200 text-sm sm:text-lg md:text-xl">Complaints Reported</p>
          </div>
          <div>
            <div className="text-3xl sm:text-4xl md:text-5xl font-bold drop-shadow-lg">{resolved}+</div>
            <p className="text-gray-200 text-sm sm:text-lg md:text-xl">Crimes Resolved</p>
          </div>
          <div>
            <div className="text-3xl sm:text-4xl md:text-5xl font-bold drop-shadow-lg">{policeUsers}+</div>
            <p className="text-gray-200 text-sm sm:text-lg md:text-xl">Active Police Users</p>
          </div>
        </div>
      </section>

      {/* Call to Action Banner */}
      <section className="relative py-16 md:py-32 px-4 sm:px-6 md:px-20 text-center">
        <div className="absolute inset-0 bg-black/60 backdrop-blur-[1px] -z-10"></div>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 drop-shadow-lg">
          Be the Change. Report Today.
        </h2>
        <p className="mb-8 text-gray-200 text-sm sm:text-base md:text-lg drop-shadow-md">
          Help build safer communities by reporting suspicious activities or crimes.
        </p>
        <Link
          to="/signup"
          className="px-6 sm:px-8 py-3 bg-gradient-to-r from-purple-600 to-purple-800 hover:from-purple-700 hover:to-purple-900 rounded-full shadow-2xl transition-all duration-300 text-lg font-semibold"
        >
          Get Started
        </Link>
      </section>
